...
const TechnicalSkills = () => {
  ...
  const skillCategories = {
    languages: {
      ...
      color: "blue",
      skills: [
        { name: "Python", level: 95, projects: "AI/ML, Web Scraping, Data Analysis" },
        { name: "Java", level: 85, projects: "Enterprise Applications, Android Development" },
        { name: "JavaScript", level: 80, projects: "Full Stack Web Development" },
        { name: "PHP", level: 85, projects: "Laravel Applications, Backend Development" },
        { name: "C/C++", level: 75, projects: "System Programming, Algorithms" },
        { name: "HTML/CSS", level: 90, projects: "Frontend Development, UI Design" }
      ]
    },
    frameworks: {
    ...
    tools: {
      ...
      skills: [
        ...
        { name: "Power BI", level: 85, projects: "Data Visualization, Analytics" },
    ...
    design: {
      ...
      skills: [
        ...
        { name: "Adobe Suite", level: 70, projects: "Graphic Design" }
      ]
    },
    domains: {
      ...
      color: "cyan",
      skills: [
        { name: "Machine Learning", level: 90, projects: "Predictive Models, AI Solutions" },
        { name: "Data Analysis", level: 85, projects: "Research, Insights" },
        { name: "Web Development", level: 90, projects: "Full Stack Applications" },
        { name: "API Integration", level: 85, projects: "System Connections" },
        { name: "Database Design", level: 80, projects: "Schema Design, Optimization" }
      ]
    }
  };
    ...
    <section id="skills" className="py-12 sm:py-16 lg:py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-gray-400 text-base sm:text-lg">Comprehensive technology stack and expertise</p>
        </div>
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className={`text-sm font-bold ${
                    skillCategories[activeCategory as keyof typeof skillCategories].color === 'blue' ? 'text-blue-400' :
                    skillCategories[activeCategory as keyof typeof skillCategories].color === 'green' ? 'text-green-400' :
                    skillCategories[activeCategory as keyof typeof skillCategories].color === 'purple' ? 'text-purple-400' :
                    skillCategories[activeCategory as keyof typeof skillCategories].color === 'pink' ? 'text-pink-400' :
                    'text-cyan-400'
                  }`}>
                    {skill.level}%
                  </span>
                ...
                <div className="w-full bg-slate-700 rounded-full h-2 mb-3">
                  <div
                    className={`h-2 rounded-full bg-gradient-to-r ${getProgressColor(
                      skillCategories[activeCategory as keyof typeof skillCategories].color
                    )} transition-all duration-1000 ease-out`}
                    style={{ width: `${skill.level}%` }}
                  ></div>
                </div>
                
                <p className="text-gray-400 text-xs sm:text-sm">{skill.projects}</p>
              </div>
            ))}
          </div>
        </div>
